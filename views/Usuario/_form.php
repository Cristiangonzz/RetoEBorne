...
<section class="register-account">
    <div class="signform">
        <div class="right" style='background-color: whitesmoke; padding: 40px;border-radius: 35px;'>
            <div class="headit">
            ...
            <div class="form">
                ...
                <input class="subbt" type="submit" value="Registrase" style="border:none;" />
